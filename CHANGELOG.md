...
### Changed
- **The ClawHub bundle plugin moved from `@aiops-tools/identity-aiops` to
  `@zw008/identity-aiops`**, matching the publisher the skill has always been under.
  ...
  `openclaw plugins install clawhub:@zw008/identity-aiops`. Nothing about the Python
...
- **The OpenClaw install path is documented.** The ClawHub bundle channel went
  ...
  `openclaw plugins install clawhub:@aiops-tools/identity-aiops`. States the `uvx`
